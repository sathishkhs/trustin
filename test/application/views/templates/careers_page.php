...
<!-- End Google Tag Manager (noscript) -->
	...
	<div class="page-wrapper">
		...
		<?php $this->load->view('careers/banner'); ?>
		<?php $this->load->view($view_path); ?>
		<?php if( $page_items->page_slug == 'heart_check_up' || $page_items->page_slug == 'contact-us' || $page_items->page_slug == 'arthritis' ){
		    
		}else{ 
		$this->load->view('templates/includes/appointment'); 
		}
		?>
