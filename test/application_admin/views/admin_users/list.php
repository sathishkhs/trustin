			...
			<div class="col-md-12">
              ...
              <div class="box-tools">
                <div class="input-group input-group-sm" style="width: 150px;">
                	<p class="text-right"><button class="btn btn-default"><i class="fa fa-plus"></i> <?php echo anchor('admin-users/add', 'Add New Adminuser'); ?></button></p>
                </div>
              </div>
            </div>
	       	<div class="box-body table-responsive no-padding">
	                    ...
	                    <tr>
	                        ...
	                        <td><?php echo($row -> role_id == 2) ? "Admin" : "Operator"; ?></td>
	                        ...
	                        <td class="td-actions">
	                            <div class="action-buttons">
	                                <a class="" title="Edit" href="<?php echo site_url('admin-users/edit/' . $row -> user_id); ?>">
	                                  <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>&nbsp;
	                                <a class="red" title="Delete" href="<?php echo site_url('admin-users/delete/' . $row -> user_id); ?>"> 
	                                  <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a>&nbsp;
	                                <a class="" title="Access" href="<?php echo site_url('admin-users/access/' . $row -> user_id); ?>">
