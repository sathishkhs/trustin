    ...
    public function save() {
       ...
       /* if (!empty($_FILES['image_path']['name'])) {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $icon_path = $_FILES['icon_path']['name'];
            $this->upload->initialize($this->icon_image_upload_config);
            if (!empty($icon_path) && $this->upload->do_upload('icon_path')) {
                $upload_data = $this->upload->data();
                $this->specialities_model->data['icon_path'] = $upload_data['file_name'];
            } else {
                $data['form_error']['icon_path'] = $this->upload->display_errors();
            }
