			...
			<div class="col-md-12">
              ...
              <div class="box-tools">
                <div class="input-group input-group-sm" style="width: 150px;">
                	<p class="text-right"><button class="btn btn-default"><i class="fa fa-plus"></i> <?php echo anchor('faq/add', 'Add New FAQ'); ?></button></p>
                </div>
              </div>
            </div>
	       	<div class="box-body table-responsive no-padding">
                 ...
                 <!-- <p class="text-left" style="float: left;"><input type="submit" class="btn btn-default" value="Submit" onclick="return chk_sel_list();"/></p>                  -->
                        ...
                        <tr>
                            <td class="center"><label><input type="checkbox" class="checkbox1" name="checkbox[<?php echo $row->faq_id;?>]" value="<?php echo $row->faq_id;?>"/><span class="lbl"></span></label></td>                            
                            ...
                            <td class="td-actions">
                                <div class="action-buttons">
                                    <a class="" title="View / Edit" href="<?php echo site_url('faq/edit/'.$row->faq_id);?>">
                                      <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>&nbsp;
                                    <a class="red" href="<?php echo site_url('faq/delete/'.$row->faq_id); ?>"> 
