...
$route['trustin-run'] = "index/pinkathon";
// $route['pinkathon2021'] = "pages/index/home";
$route['heart_check_up'] = "index/health_check_up";
$route['arthritis'] = "index/arthritis";
$route['blood_donation_camp'] = "index/blood_donation_camp";
$route['surgical_camp'] = "index/surgical_camp";
$route['women_health_camp'] = "index/women_health_camp";
$route['independence_day'] = "index/independence_day";
