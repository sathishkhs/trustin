...
with advanced medical equipment, modern infrastructure, specialised doctors, and cost-effective treatment enabling comprehensive treatment for both outpatient and inpatient. </p>
		...
		<section class="count-number count-area" data-diff="100" style="background:#f4f4f4;">
							<div class="container">
								<div class="row">
									<div class="col-sm-6 col-md-4">
										<div class="count-area-content">
											<div class="count-icon"><img src="front/images/ico-Modular-red.png"></div>
											<div class="count-digit">4500</div>
											<div class="count-title">No. of Surgeries Done</div>
										</div>
									</div>
									<div class="col-sm-6 col-md-4">
										<div class="count-area-content">
											<div class="count-icon"><img src="front/images/ico-opd-red.png"></div>
											<div class="count-digit">72000</div>
											<div class="count-title">No. of Patient's Visited</div>
										</div>
									</div>
									<div class="col-sm-6 col-md-4">
										<div class="count-area-content">
											<div class="count-icon"><img src="front/images/ico-icu-red.png"></div>
											<div class="count-digit">100</div>
											<div class="count-title">No. of Beds</div>
										</div>
									</div>
								</div>
							</div>
