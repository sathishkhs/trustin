                    ...
                    //     e.preventDefault();
                        ...
                        $.ajax({
                              ...
                              success:function(data){
                                  console.log(data)
                                      if(data == 1){
                                    $('.appointments').html('<h4 style="color:white">Form submission successful. Our support team will get in touch with you please be patience.</h4>')
                                          }else if(data == 0){
                                            $('.appointments').html('<h4 style="color:white">Sorry Form submission failed. Please try again.</h4>')
                                              }
                                          }
                                        });
                                        // });
